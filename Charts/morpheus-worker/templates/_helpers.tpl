...
*/}}
{{- define "morpheus-worker.fullname" -}}
...
Common labels
*/}}
{{- define "morpheus-worker.labels" -}}
helm.sh/chart: {{ include "morpheus-worker.chart" . }}
{{ include "morpheus-worker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "morpheus-worker.selectorLabels" -}}
